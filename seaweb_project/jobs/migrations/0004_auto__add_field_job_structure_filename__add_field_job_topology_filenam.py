...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.structure_filename'
        db.add_column(u'jobs_job', 'structure_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Job.topology_filename'
        db.add_column(u'jobs_job', 'topology_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.structure_filename'
        db.delete_column(u'jobs_job', 'structure_filename')

        # Deleting field 'Job.topology_filename'
        db.delete_column(u'jobs_job', 'topology_filename')
    ...
    models = {
        ...
        u'jobs.job': {
            ...
            'structure_filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            ...
            'topology_filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'})
        },
        u'jobs.result': {
